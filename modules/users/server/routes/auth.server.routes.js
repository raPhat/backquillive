...
module.exports = function (app) {
  ...
  // Setting up the users authentication api
  app.route('/api/auth/jwt/signup').post(users.jwtSignup);
  app.route('/api/auth/jwt/signin').post(users.jwtSignin);
  app.route('/api/auth/jwt/signout').get(users.jwtSignout);
